...
<body>
  ...
  <div class="flex">
    <?php var_dump(Auth::user()->is_participate($community->id)); ?>
    <div class="e">コミュニティトップ{{ Auth::user()->is_participate($community->id) }}</div>
  ...
  <div class="grid">
    ...
    <div class="photoA"><img class="syoki" src="{{ asset('/uploads/' . $participation->profile->image)}}"></div>
    @endforeach
  </div>
  <div class="grid2">
